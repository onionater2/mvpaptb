function [subj] = hpfilter_runs_xsubj(subj,patname,selname,cutoff,tr,varargin)
% variant of ptb function, edited by AES for cross subject decoding
% bypasses the sanity check to avoid jumbled run error when performing
