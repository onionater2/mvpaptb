function [subj] = interpret_weights_aes(subj,results,varargin)
%AES plans to edit this for compatibility with libsvm
...
for i=1:nRuns   
  ...
  mask_name{i}='whole_brain_skullstripped';
  ...
  masked_pats = get_masked_pattern_AES(subj,pats_name,mask_name{i}); 
...
function [masked_pat ia ib] = get_masked_pattern_AES(subj,patname,maskname)
...
parentvol = get_mat(subj,'mask',maskname);
