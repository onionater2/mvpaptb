function [merged unused] = propval_AES(propvals, defaults, varargin)
%edited by AES to enable backwards compatibility
...
pvdef.ignore_missing_default = true; %AES edited to true from false
pvdef.ignore_empty_defaults = true; %AES edited to true from false
